...
from tvb.datatypes.projections import ProjectionMatrix, make_proj_matrix, ProjectionsTypeEnum
from tvb.datatypes.region_mapping import RegionVolumeMapping, RegionMapping
from tvb.datatypes.sensors import Sensors, make_sensors, SensorTypesEnum
...
from tvb.datatypes.surfaces import Surface, make_surface, SurfaceTypesEnum
...
def populate_datatypes_registry():
    ...
    REGISTRY.register_datatype(Sensors, SensorsH5, SensorsIndex, make_sensors, SensorTypesEnum)
    ...
    REGISTRY.register_datatype(Surface, SurfaceH5, SurfaceIndex, make_surface, SurfaceTypesEnum)
