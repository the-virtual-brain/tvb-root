...
class NetworkxConnectivityImporterForm(ABCUploaderForm):
    def __init__(self):
        ...
        self.data_file = TraitUploadField(
            NetworkxImporterModel.data_file, ".gpickle", "data_file"
        )
        self.key_edge_weight = StrField(
            NetworkxImporterModel.key_edge_weight, "key_edge_weight"
        )
        self.key_edge_tract = StrField(
            NetworkxImporterModel.key_edge_tract, name="key_edge_tract"
        )
        self.key_node_coordinates = StrField(
            NetworkxImporterModel.key_node_coordinates, name="key_node_coordinates"
        )
        self.key_node_label = StrField(
            NetworkxImporterModel.key_node_label, name="key_node_label"
        )
        self.key_node_region = StrField(
            NetworkxImporterModel.key_node_region, name="key_node_region"
        )
        self.key_node_hemisphere = StrField(
            NetworkxImporterModel.key_node_hemisphere, name="key_node_hemisphere"
        )
...
class NetworkxConnectivityImporter(ABCUploader):
    ...
    def launch(self, view_model):
        ...
        try:
            ...
            with open(view_model.data_file, "rb") as f:
