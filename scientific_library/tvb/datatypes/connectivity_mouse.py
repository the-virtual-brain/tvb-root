...
"""
The datatypes in this module wrap objects from the Allen Institute's SDK.
...
from tvb.basic.traits.types_basic import Integer, String
from tvb.basic.traits.types_mapped import MappedType
import allensdk.core.mouse_connectivity_cache

class MouseConnectivityCache(MappedType):
    resolution = Integer()
