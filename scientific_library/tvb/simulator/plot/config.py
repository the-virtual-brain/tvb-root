...
class InputConfig(object):
    _base_input = os.getcwd() if TvbProfile.is_library_mode() else TvbProfile.current.TVB_LOG_FOLDER
...
class OutputConfig(object):
    ...
    def __init__(self, out_base=None, separate_by_run=False):
        ...
        """
        self._out_base = out_base or os.path.join(os.getcwd(),
                                                  "outputs") if TvbProfile.is_library_mode() else TvbProfile.current.TVB_STORAGE
