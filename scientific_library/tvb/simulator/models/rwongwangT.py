...
class rwongwang(ModelNumbaDfun):
    ...
    def dfun(self, vw, c, local_coupling=0.0):
        ...
        deriv = _numba_dfun_rwongwang(vw_, c_, self.w_plus, self.a_E, self.b_E, self.d_E, self.a_I, self.b_I, self.d_I, self.gamma_E, self.tau_E, self.tau_I, self.I_0, self.w_E, self.w_I, self.gamma_I, self.J_N, self.J_I, self.G, self.lamda, self.J_NMDA, self.JI, local_coupling)
...
def _numba_dfun_rwongwang(vw, coupling, w_plus, a_E, b_E, d_E, a_I, b_I, d_I, gamma_E, tau_E, tau_I, I_0, w_E, w_I, gamma_I, J_N, J_I, G, lamda, J_NMDA, JI, local_coupling, dx):
