...
class ReducedWongWangProxy(ReducedWongWang, ModelWithProxy):
    """
    ...
    def config_for_sim(self, simulator):
        ...
        if hasattr(simulator.model, '_id_proxy'):
            ...
            if self._model_with_proxy is None:
                ...
                class ModelProxy(model_class, ModelWithProxy):
                    """
                    ...
                    def dfun(self, x, c, local_coupling=0.0):
                        if self._update:
                            ...
                            self._update = False
                        deriv = super(ModelProxy, self).dfun(x, c, local_coupling)
                        return deriv

                self._model_with_proxy = ModelProxy
            else:
        ...
        # access to the model method (I am not sure to be the best way)
        simulator.integrator.interface_co_simulation = self
