...
from tvb.simulator.interface_co_simulation import ReducedWongWangProxy, InterfaceCoSimulation
import numpy as np
...
class TestModifyWongWangSimple(TestModifyWongWang):
    ...
    def test_with_proxy_badd_monitor(self):
        ...
        monitors_2 = (
            InterfaceCoSimulation(period=0.1, id_proxy=np.array([0, 2], dtype=np.int), time_synchronize=10.0),)
        # Initialise a Simulator -- Model, Connectivity, Integrator, and Monitors.
