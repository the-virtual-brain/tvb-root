...
parser = argparse.ArgumentParser(description='Reproduce results of Figure 17, third column presented in Sanz-Leon et al 2014')
...
if args['sim']:
    for i in range(3):
        ...
        oscilator = models.WilsonCowan(c_ee = 16., c_ei=12., 
                                       c_ie=15., c_ii=3, 
                                       tau_e=8., tau_i=8., 
                                       a_e=1.3, a_i=2., 
                                       b_e=4., b_i=3.7, 
