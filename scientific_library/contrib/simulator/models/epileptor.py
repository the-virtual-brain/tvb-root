...
def _numba_dfun(y, c_pop, x0, Iext, Iext2, a, b, slope, tt, Kvf, c, d, r, Ks, Kf, aa, tau, modification, ydot):
...
class Epileptor(ModelNumbaDfun):
    ...
    def dfun(self, x, c, local_coupling=0.0):
        ...
        deriv = _numba_dfun(x_, c_,
                         ...
                         self.c, self.d, self.r, self.Ks, self.Kf, self.aa, self.tau, self.modification)
