...
#include "tvb_hybrid_cpp_574359f669ba1060.cpp"

namespace py = pybind11;
using namespace tvb::hybrid::runtime;

PYBIND11_MODULE(tvb_hybrid_cpp_574359f669ba1060, m) {
  ...
  // Parameters
  // ----------
  // initial_states        : list of 2 numpy arrays, one per subnet,
      ...
      [](py::list  initial_states,
        ...
        if (n_subnets != 2) {
          throw std::runtime_error(
              "run_simulation: expected 2 initial_states, got " +
