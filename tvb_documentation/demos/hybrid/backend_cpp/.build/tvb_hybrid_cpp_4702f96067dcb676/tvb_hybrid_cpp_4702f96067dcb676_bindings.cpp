...
#include "tvb_hybrid_cpp_4702f96067dcb676.cpp"

namespace py = pybind11;
using namespace tvb::hybrid::runtime;

PYBIND11_MODULE(tvb_hybrid_cpp_4702f96067dcb676, m) {
  ...
  // Parameters
  // ----------
  // initial_states        : list of 1 numpy arrays, one per subnet,
      ...
      [](py::list  initial_states,
        ...
        if (n_subnets != 1) {
          throw std::runtime_error(
              "run_simulation: expected 1 initial_states, got " +
