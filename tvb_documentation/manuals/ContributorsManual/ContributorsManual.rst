...
.. code-block:: bash
   ...
   $ pip install h5py>=2.10 formencode cfflib jinja2 nibabel sqlalchemy==1.3.20 sqlalchemy-migrate==0.13.0 allensdk tvb-gdist typing BeautifulSoup4 subprocess32 flask-restplus python-keycloak mako
