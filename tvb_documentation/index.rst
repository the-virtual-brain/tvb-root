...
On CERN's data sharing platform *Zenodo*, we offer `various demonstration datasets <https://zenodo.org/record/8331301>`_, readily packaged for usage with The Virtual Brain software.
