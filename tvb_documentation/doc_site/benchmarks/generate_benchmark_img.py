...
plot(131, "Generic2dOscillator 1000sec", 20,
     [14.5, 17.9, 6.3], "nodes=192 dt=0.05",
     [9.5, 11.0, 6.1], "nodes=96 dt=0.05",
     [5, 5.9, 3.5], "nodes=96 dt=0.1")

plot(132, "Epileptor 1000sec", 30,
     [21.8, 25.5, 10.3], "nodes=192 dt=0.05",
     [12.8, 16.2, 9.1], "nodes=96 dt=0.05",
     [6.7, 7.5, 4.3], "nodes=96 dt=0.1")

plot(133, "LarterBreakspear 10000sec", 180,
     [159.6, 145.4, 89.5], "nodes=192 dt=0.1",
     [88.6, 89.8, 78.8], "nodes=96 dt=0.1",
     [40.7, 39.0, 43.9], "nodes=96 dt=0.2")
