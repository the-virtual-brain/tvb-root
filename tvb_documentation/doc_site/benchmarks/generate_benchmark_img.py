...
plot(131, "Generic2dOscillator 1000sec", 20,
     [14.5, 17.9, 6.6, 7.2, 7.2, 11.6], "nodes=192 dt=0.05",
...
plot(132, "Epileptor 1000sec", 25,
     ...
     [12.8, 16.2, 8.7, 8.7, 9.3, 15.4], "nodes=96 dt=0.05",
     [6.7, 7.5, 4.6, 5.0, 5.0, 10], "nodes=96 dt=0.1")
...
plot(133, "LarterBreakspear 10000sec", 200,
     ...
     [40.7, 39.0, 39.1, 39.4, 39.8, 91], "nodes=96 dt=0.2")
