...
x = [1, 2, 3, 4, 5]
x_labels = ["1.4", "1.4.1", "1.5", "1.5.4", "1.5.9"]
figure = pyplot.figure(figsize=(12, 11))

plot(131, "Generic2dOscillator 1000sec", 20,
     [14.5, 17.9, 6.6, 7.2, 7.2], "nodes=192 dt=0.05",
     [9.5, 11.0, 6.2, 7.0, 7.1], "nodes=96 dt=0.05",
     [5, 5.9, 3.5, 3.6, 4.2], "nodes=96 dt=0.1")

plot(132, "Epileptor 1000sec", 30,
     [21.8, 25.5, 9.1, 8.9, 9.5], "nodes=192 dt=0.05",
     [12.8, 16.2, 8.7, 8.7, 9.3], "nodes=96 dt=0.05",
     [6.7, 7.5, 4.6, 5.0, 5.0], "nodes=96 dt=0.1")

plot(133, "LarterBreakspear 10000sec", 180,
     [159.6, 145.4, 82.8, 79.2, 78.5], "nodes=192 dt=0.1",
     [88.6, 89.8, 71.1, 74.6, 74.5], "nodes=96 dt=0.1",
     [40.7, 39.0, 39.1, 39.4, 39.8], "nodes=96 dt=0.2")
