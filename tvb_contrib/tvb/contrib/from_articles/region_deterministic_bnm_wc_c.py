...
"""
What:
     Reproduces Figure 17, third column, of Sanz-Leon P., Knock, S. A., Spiegler, A. and Jirsa V.
...
Run:
     python region_deterministic_bnm_wc_c.py -s True -f True

     #Subsequent calls can be made with: 
     python region_deterministic_bnm_wc_c.py -f True
...
parser = argparse.ArgumentParser(
    description='Reproduce results of Figure 17, third column presented in Sanz-Leon et al 2014')
...
if args['sim']:
    for i in range(3):
        ...
        oscilator = models.WilsonCowan(c_ee=numpy.array([16.]), c_ei=numpy.array([12.]),
                                       c_ie=numpy.array([15.]), c_ii=numpy.array([3]),
                                       tau_e=numpy.array([8.]), tau_i=numpy.array([8.]),
                                       a_e=numpy.array([1.3]), a_i=numpy.array([2.]),
                                       b_e=numpy.array([4.]), b_i=numpy.array([3.7]),
                                       P=numpy.array([1.25]),
