...
"""
What:
     Reproduces Figure 13, first column,  of Sanz-Leon P., Knock, S. A., Spiegler, A. and Jirsa V.
...
Run:
     python region_deterministic_bnm_g2d_a.py -s True -f True

     #Subsequent calls can be made with: 
     python region_deterministic_bnm_g2d_a.py -f True
