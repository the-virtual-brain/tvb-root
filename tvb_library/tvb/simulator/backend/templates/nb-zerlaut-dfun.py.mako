...
<%
    ...
    # 1e-4 gives a reasonable accuracy/stability trade-off. Kept in sync with
    # nb-zerlaut-sweep-cuda.py.mako so single-run and sweep agree.
    _df = "nb.float32(1e-4)"
    _df_scale = "nb.float32(1e3)"
%>
