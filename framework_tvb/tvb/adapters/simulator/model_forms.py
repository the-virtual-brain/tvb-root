...
def get_ui_name_to_model():
    ui_name_to_model = {
        'Generic_2d_Oscillator': ModelsEnum.GENERIC_2D_OSCILLATOR.get_class(),
        'Kuramoto_Oscillator': ModelsEnum.KURAMOTO.get_class(),
        ...
        'Epileptor_codim_3': ModelsEnum.EPILEPTOR_CODIM_3.get_class(),
        'Epileptor_codim_3_ultra-slow_modulations': ModelsEnum.EPILEPTOR_CODIM_3_SLOW.get_class(),
        ...
        'Reduced_Wong-Wang': ModelsEnum.REDUCED_WONG_WANG.get_class(),
        'Reduced_Wong-Wang_with_Excitatory_and_Inhibitory_Coupled_Populations': ModelsEnum.REDUCED_WONG_WANG_EXCH_INH.get_class(),
        'Stefanescu-Jirsa_2D': ModelsEnum.REDUCED_SET_FITZ_HUGH_NAGUMO.get_class(),
        'Stefanescu-Jirsa_3D': ModelsEnum.REDUCED_SET_HINDMARSH_ROSE.get_class(),
        'Zerlaut_adaptation_first_order': ModelsEnum.ZERLAUT_FIRST_ORDER.get_class(),
        'Zerlaut_adaptation_second_order': ModelsEnum.ZERLAUT_SECOND_ORDER.get_class(),
        'Linear_model': ModelsEnum.LINEAR.get_class(),
