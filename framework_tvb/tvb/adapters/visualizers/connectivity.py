...
class Connectivity2DViewer(object):
    ...
    def compute_parameters(self, input_data, colors=None, rays=None, step=None):
        ...
        if min(input_data.hemispheres) == max(input_data.hemispheres) and min(input_data.hemispheres) == False:
            right_json = ""
        else:
        ...
        if min(input_data.hemispheres) == max(input_data.hemispheres) and min(input_data.hemispheres) == True:
            left_json = ""
        else:
