...
class EegMonitorForm(ABCAdapterForm):
    ...
    def __init__(self, prefix='', project_id=None):
        ...
        self.input_data = TraitDataTypeSelectField(EegMonitorModel.input_data, self.project_id, self.draw_ranges,
                                                   name='input_data')
        self.data_2 = TraitDataTypeSelectField(EegMonitorModel.data_2, self.project_id, self.draw_ranges, name='data_2')
        self.data_3 = TraitDataTypeSelectField(EegMonitorModel.data_3, self.project_id, self.draw_ranges, name='data_3')
