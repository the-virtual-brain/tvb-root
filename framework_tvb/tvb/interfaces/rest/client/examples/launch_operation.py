...
if __name__ == '__main__':
    ...
    operation_gid = tvb_client.launch_operation(project_gid, algorithm_module, algorithm_class, connectivity_view_model,
                                                data_file_path_1=conn_zip_path)
    ...
    operation_gid = tvb_client.launch_operation(project_gid, algorithm_module, algorithm_class, surface_view_model,
                                                data_file_path_1=surface_zip_path)
    ...
    operation_gid = tvb_client.launch_operation(project_gid, algorithm_module, algorithm_class, rm_view_model,
                                                data_file_path_1=rm_text_path)
    ...
    operation_gid = tvb_client.launch_operation(project_gid, algorithm_module, algorithm_class, csv_view_model,
                                                data_file_path_1=csv_weights_path, data_file_path_2=csv_tracts_path)
